...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> CRYPTIC_BLOCK = register("cryptic_block",
            () -> new Block(AbstractBlock.Properties.create(Material.IRON)
                    .hardnessAndResistance(3f, 10f).sound(SoundType.METAL)));

    public static final RegistryObject<Block> CRYPTIC_ORE = register("cryptic_ore",
            () -> new Block(AbstractBlock.Properties.create(Material.ROCK)
                    .tickRandomly().setLightLevel((state) -> 2).hardnessAndResistance(10f, 10f)
    ...
    public static final RegistryObject<Block> VOID_DE_CROP =
            Registration.BLOCKS.register("void_de_crop",
                    () -> new VoidDeCrop(AbstractBlock.Properties.from(Blocks.WHEAT)));
