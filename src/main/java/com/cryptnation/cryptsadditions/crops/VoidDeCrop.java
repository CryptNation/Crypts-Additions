package com.cryptnation.cryptsadditions.crops;
...
public class VoidDeCrop extends CropsBlock {
	...
	public VoidDeCrop(Properties builder) {
		super(builder);
	}
	...
	protected IItemProvider getSeedsItem() {
		return ModItems.VOID_DE_SEED.get();
	}
